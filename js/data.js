...
const PEOPLE = [
  {
    ...
    works: [
      ...
      { title: "Light Novel Date or Fail", desc: "Karya sastra pertama saya, menceritakan tentang Souta-seorang anak SMA yang sedang berusaha memecahkan misteri di sekolahnya...", link: "Google Docs", stack: ["GDocs", "ChatGPT"] }
    ],
    skills: [
      { name: "Python", pct: 82 },
